...
// color picker start
    (function() {
		...
		'<a href="#" class="handle">' +
		'<img class="setting-icon" src="assets/img/settings.png" alt="setting icon">' +
