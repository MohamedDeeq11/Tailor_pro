        ...
        <div class="card" id="bootstrap-table4">
            <div class="card-header flex-wrap d-flex justify-content-between border-0 px-3">
                <div style="background-color: ">
                    <br>
                    <a href="{{ route('clients.create') }}" class="btn btn-primary" style="margin-right: 10px;">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <form action="{{ route('clients.destroy', $client->id) }}" method="POST">
                                                    <div class="d-flex">
                                                        <a href="{{ route('clients.show',encrypt($client->id) ) }}" class="btn btn-warning shadow btn-xs sharp me-1">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('clients.edit', encrypt($client->id)) }}" class="btn btn-primary shadow btn-xs sharp me-1">
