        ...
        <div class="card" id="bootstrap-table4">
            <div class="card-header flex-wrap d-flex justify-content-between border-0 px-3">
                <div style="background-color: ">
                    <br>
                    <a href="{{ route('expenses.create') }}" class="btn btn-primary" style="margin-right: 10px;">
                        <i class="fa fa-add"></i> Add New Expense
                    </a>
                </div>
            </div>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <form action="{{ route('expenses.destroy', $expense->id) }}" method="POST">
                                                        <div class="d-flex">
                                                            <a href="{{ route('expenses.show', encrypt($expense->id)) }}" class="btn btn-warning shadow btn-xs sharp me-1">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                            <a href="{{ route('expenses.edit',  encrypt($expense->id)) }}" class="btn btn-primary shadow btn-xs sharp me-1">
