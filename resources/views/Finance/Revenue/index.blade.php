									...
									<div class="card" id="bootstrap-table4">
										<div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
											<div style="background-color: ">
												<br>
                                                <a href="{{ route('revenues.create') }}" class="btn btn-primary" style="margin-right: 10px;">
                                                    <i class="fa fa-add"></i> Add New Revenue
                                                </a>
											</div>
																			...
																			<td>
                                                                                <div class="d-flex">
																				    <form action="{{ route('revenues.destroy',$revenue->id) }}" method="POST">
                                                                                        <div class="d-flex">
                                                                                            <a href="{{ route('revenues.show', encrypt($revenue->id)) }}" class="btn btn-warning shadow btn-xs sharp me-1">
                                                                                                <i class="fa fa-eye"></i>
                                                                                            </a>
                                                                                        <a href="{{ route('revenues.edit', encrypt($revenue->id)) }}" class="btn btn-primary shadow btn-xs sharp me-1">
