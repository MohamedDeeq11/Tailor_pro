        ...
        <div class="row" style="overflow-y: scroll; height: 500px;">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    @endif
                    <form action="{{ route('order_trackings.store') }}" method="POST">
                        <div class="card-body">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-8 col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="expected_date_completion" id="exampleFormControlInput3" placeholder="Enter Expected Date Of Completion">
                                            </div>
                                        </div>
                                    </div>
                                </div>
