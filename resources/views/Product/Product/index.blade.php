        ...
        <div class="card" id="bootstrap-table4">
            <div class="card-header flex-wrap d-flex justify-content-between border-0 px-3">
                <div style="background-color: ">
                    <br>
                    <a href="{{ route('products.create') }}" class="btn btn-primary" style="margin-right: 10px;">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <form action="{{ route('products.destroy', $product->id) }}" method="POST">
                                                    <div class="d-flex">
                                                        <a href="{{ route('products.show', encrypt($product->id)) }}" class="btn btn-warning shadow btn-xs sharp me-1">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('products.edit', encrypt($product->id)) }}" class="btn btn-primary shadow btn-xs sharp me-1">
