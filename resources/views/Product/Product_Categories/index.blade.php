        ...
        <div class="card" id="bootstrap-table4">
            <div class="card-header flex-wrap d-flex justify-content-between border-0 px-3">
                <div style="background-color: ">
                    <br>
                    <a href="{{ route('product_categories.create') }}" class="btn btn-primary" style="margin-right: 10px;">
                        <i class="fa fa-plus"></i> Add New Product Category
                    </a>
                </div>
            </div>
                            ...
                            <table id="example3" class="display table" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $product_category->CategorieName }}</td>
                                        <td>
                                            <div class="d-flex">
                                                <form action="{{ route('product_categories.destroy', $product_category->id) }}" method="POST">
                                                    <div class="d-flex">
                                                        <a href="{{ route('product_categories.show', encrypt($product_category->id) ) }}" class="btn btn-warning shadow btn-xs sharp me-1">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('product_categories.edit',  encrypt($product_category->id)) }}" class="btn btn-primary shadow btn-xs sharp me-1">
