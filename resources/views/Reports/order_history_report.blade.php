																			...
																			{{-- <td>
                                                                                <div class="d-flex">
																				    <form action="{{ route('order_historys.destroy',$order_history->id) }}" method="POST">
                                                                                        <div class="d-flex">
                                                                                            <a href="{{ route('order_historys.show', $order_history->id) }}" class="btn btn-warning shadow btn-xs sharp me-1">
                                                                                                <i class="fa fa-eye"></i>
                                                                                            </a>
                                                                                        <a href="{{ route('order_historys.edit', $order_history->id) }}" class="btn btn-primary shadow btn-xs sharp me-1">
