                                    ...
                                    {{-- <td>
                                        <div class="d-flex">
                                            <form action="{{ route('profits.destroy',$profit->id) }}" method="POST">
                                                <div class="d-flex">
                                                    <a href="{{ route('profits.show', $profit->id) }}" class="btn btn-warning shadow btn-xs sharp me-1">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                <a href="{{ route('profits.edit', $profit->id) }}" class="btn btn-primary shadow btn-xs sharp me-1">
