    ...
    <div class="card h-100 shadow-lg">
      <div class="card-body">
        <div class="text-center p-4">
          ...
          <br><br>
          <span class="h1" style="margin-left: 20px">{{ $plan->price }}</span>/month
          <br><br>
        </div>
      ...
      <div class="card-body text-center">
        <p class="btn-holder"><a href="{{ route('addplan.to.cart', $plan->id) }}" class="btn btn-outline-danger">Buy</a> </p>
      </div>
    </div>
  </div>
  @endforeach
