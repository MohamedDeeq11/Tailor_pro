        ...
        <div class="card" id="bootstrap-table4">
            <div class="card-header flex-wrap d-flex justify-content-between border-0 px-3">
                <div style="background-color: ">
                    <br>
                    <a href="{{ route('branchs.create') }}"  class="btn btn-primary" style="margin-right: 10px;">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <form action="{{ route('branchs.destroy', $branch->id) }}" method="POST">
                                                    <div class="d-flex">
                                                        <a href="{{ route('branchs.show',encrypt($branch->id) ) }}" class="btn btn-warning shadow btn-xs sharp me-1">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('branchs.edit', encrypt($branch->id) ) }}" class="btn btn-primary shadow btn-xs sharp me-1">
