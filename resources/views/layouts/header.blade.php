                                ...
                                <div class="card-body px-0">
                                    ...
                                    <div class="dlab-scroll px-3 mt-3 height300">
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{url('/images/avatar/1.jpg')}}" class="avatar avatar-sm" alt="">
                                        ...
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{url('/images/avatar/2.jpg')}}" class="avatar avatar-sm" alt="">
                                        ...
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{url('/avatar/2.jpg')}}" class="avatar avatar-sm" alt="">
                                                <a href="javascript:void(0);" class="ms-2">Benjamin</a>
                                        ...
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{url('/images/avatar/4.jpg')}}" class="avatar avatar-sm" alt="">
                                                <a href="javascript:void(0);" class="ms-2">Benjamin</a>
                                        ...
                                        <ul class="d-flex align-items-center mb-3">
                                            <li>
                                                <img src="{{url('/images/avatar/3.jpg')}}" class="avatar avatar-sm" alt="">
                                                <a href="javascript:void(0);" class="ms-2">Benjamin</a>
                            ...
                            <div class="dropdown-menu dropdown-menu-end pb-0" style="">
                                <div class="card mb-0">
                                    ...
                                    <div class="card-body p-3">
                                        <a href="{{url('my_profile')}}" class="dropdown-item ai-icon ">
                                    ...
                                    <div class="card-footer text-center p-3">
                                        <a href="{{url('logout')}}" class="dropdown-item ai-icon btn btn-primary light">
