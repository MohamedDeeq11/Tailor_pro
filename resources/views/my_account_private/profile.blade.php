                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="user">
                                ...
                                <div>
                                    <h2 class="mb-0">{{$profile->fname}} {{$profile->lname}}</h2>
                            ...
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item" href="{{url('private_edit_profile')}}">Edit Profile</a>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-xl-3 col-xxl-6 col-sm-6">
                                ...
                                <ul class="student-details">
                                    ...
                                    <li><span>Address:</span><h5 class="mb-0">{{$profile->address}}</h5></li>
                                </ul>
                            </div>
                            <div class="col-xl-3 col-xxl-6 col-sm-6">
                                <ul class="student-details">
                                    ...
                                    <li><span>Phone:</span><h5 class="mb-0">{{$profile->mobile}}</h5></li>
                                </ul>
                            </div>
                            <div class="col-xl-4 col-xxl-6 col-sm-6">
                                <ul class="student-details">
                                    ...
                                    <li><span>Email:</span><h5 class="mb-0">{{$profile->email}}</h5></li>
                                </ul>
                            </div>
                        </div>
                    </div>
