    ...
    <div class="dlabnav-scroll">	
        <ul class="metismenu" id="menu">
           ...
           <br>
            ...
            <ul aria-expanded="false">
                <li><a href="<?php echo e(url('/company')); ?>">Manage Comapany </a></li>
                <li><a href="<?php echo e(url('/branch')); ?>">Manage Branch</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo e(url('/invocing')); ?>">Invoicing</a></li>
                    <li><a href="<?php echo e(url('/payment_processing ')); ?>">Payment Processing</a></li>
                </ul>
            ...
            <ul aria-expanded="false">
                <li><a href="<?php echo e(url('/employee')); ?>">Employee Details</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo e(url('/client_details')); ?>">Client Details</a></li>
                    <li><a href="<?php echo e(url('/order_history')); ?>">Order History</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo e(url('/order_history')); ?>">Order History</a></li>
                    <li><a href="<?php echo e(url('/order_tracking')); ?>">Order Tracking</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="<?php echo e(url('/revenue')); ?>">Revenue </a></li>
                    <li><a href="<?php echo e(url('/profit')); ?>">Profit</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="./widget-chart.html">Order history</a></li>
                    <li><a href="./widget-card.html">Sales</a></li>
                    <li><a href="./widget-list.html">Expenses </a></li>
                    <li><a href="./widget-list.html">Revenue </a></li>
                    <li><a href="./widget-list.html">Profit </a></li>
                </ul>
            </li>
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
            ...
            <ul aria-expanded="false">
                <li><a href="./form-element.html">packup</a></li>
                <li><a href="./form-element.html">Notification</a></li>
                <li><a href="./form-element.html">Apperence</a></li>
...
<!--**********************************
    Sidebar end<?php /**PATH C:\xampp\htdocs\Tailor-Pro\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>