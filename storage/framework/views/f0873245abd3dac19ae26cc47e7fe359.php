										...
										<div class="card-header flex-wrap d-flex justify-content-between  border-0 px-3">
											...
											<ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
												<li class="nav-item" role="presentation">
													<button class="nav-link active " id="home-tab-3" data-bs-toggle="tab" data-bs-target="#withoutBorder" type="button" role="tab"  aria-selected="true">Add Branch</button>
												</li>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tailor-Pro\resources\views/company/Branch/Branch.blade.php ENDPATH**/ ?>