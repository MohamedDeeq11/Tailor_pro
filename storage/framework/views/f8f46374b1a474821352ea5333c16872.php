						...
						<div class="col-xl-12 tab-content">
							...
							<?php endif; ?>>
								...
								<?php echo csrf_field(); ?>
									...
									<a href="<?php echo e(url('/forget')); ?>" class="text-primary float-end mb-4">Forgot Password ?</a>
									<button class="btn btn-block btn-primary">Sign In</button>
									
								</form>
								<div class="new-account mt-3 text-center">
									<p class="font-w500">i don't have any account? <a class="text-primary" href="<?php echo e(url('/register')); ?>"data-toggle="tab">Create an account?</a></p>
								</div>
							</div>
						</div>
					</div>
...
</html><?php /**PATH C:\xampp\htdocs\Tailor-Pro\resources\views/auth/login.blade.php ENDPATH**/ ?>