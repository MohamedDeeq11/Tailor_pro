			...
			<div class="card">
				<div class="card-body text-center ai-icon  text-primary">
					...
					<div class="new-account mt-3 text-center">
					  ...
					  <a class="text-primary" href="<?php echo e(url('/register')); ?>" style="font-size: 15px "> Back </a>
					</div>
...
</html><?php /**PATH C:\xampp\htdocs\Tailor-Pro\resources\views/auth/verified.blade.php ENDPATH**/ ?>